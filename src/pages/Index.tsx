...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div 
        className={`${
          headerDocked ? 'header-docked' : 'header-float'
        } bg-black/80 backdrop-blur-md border-b border-red-500/10 z-40`}
      >
        <Header />
      </div>
      ...
      <div className={`pt-28 w-full`}>
        ...
        >
          <div className="text-center mb-16">
            ...
            >
              <h2 className="text-4xl lg:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-400 animate-fade-in leading-tight py-2 md:text-6xl">
        ...
        <main 
          id="work" 
          ref={workSectionRef} 
          className="flex-grow max-w-7xl w-full mx-auto px-4 py-8 relative"
        >
