      ...
      <div className="pt-24 w-full">
        ...
        perspective: '1000px'
          ...
          <div className="text-center mb-16">
            <div className="mb-6 relative inline-block" style={{
            transform: `translateY(${scrollY * 0.08}px) translateZ(${scrollY * 0.05}px)`,
            opacity: Math.max(0, 1 - scrollY * 0.001)
          }}>
              <h2 className="text-4xl lg:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-400 animate-fade-in leading-tight py-[27px] md:text-6xl">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto animate-fade-in" style={{
