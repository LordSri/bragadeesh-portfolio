...
const Header = () => {
  ...
  return (
    <div className="fixed top-0 w-full z-40 transition-all duration-300 ease-linear">
      <div className="w-full backdrop-blur-xl bg-black/50 border-b border-red-500/20 shadow-lg">
